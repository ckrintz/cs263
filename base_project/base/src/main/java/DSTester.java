...
/////////////////////////////////////////////////////////
    ...
    // Return code should be 204 == no response or 200 == OK
    status = response.getStatus();
    if (status != 204 && status != 200) {
        System.out.println("Test 2 Failed: Expected status 204 or 200, got: "+status);
    } else {
...
/////////////////////////////////////////////////////////
    ...
    status = response.getStatus();
    if (status != 204 && status != 200) {
        System.out.println("Test 8 Failed: Expected status 204 or 200, got: "+status);
    } else {
